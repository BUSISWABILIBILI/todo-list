(() => {
      ...
      72(t) {
        ...
        t.exports = function (t, r) {
          ...
          return function (t) {
            ...
            for (var d = o(t, r), c = 0; c < a.length; c++) {
              var p = e(a[c]);
  ...
  function h({ name: t, id: n = crypto.randomUUID(), todos: e = [] }) {
    return { id: n, name: t, todos: e.map(k) };
  }
  function v(t, n) {
    return t.find((t) => t.id === n) || null;
  }
  function y(t, n) {
    const e = v(t, n);
    return e ? e.todos : [];
          ...
          (function (t, n) {
            ...
            return (
              o.addEventListener("submit", (e) => {
                (e.preventDefault(), n("save-edit", t.id));
              }),
  ...
  function z(t, n = {}, e = []) {
    ...
    return (
      ...
      void 0 !== n.text && (o.textContent = n.text),
      Object.entries(n.attributes || {}).forEach(([t, n]) => {
        o.setAttribute(t, n);
      }),
      Object.assign(o, n.properties || {}),
      o.append(...e),
      o
    );
  }
  ...
  !(function () {
    const t = (function (t) {
      return (
        ...
        ),
        {
          ...
          addTaskButton: t.querySelector("#add-task-button"),
          ...
          todoFooter: t.querySelector("#todo-footer"),
          todoForm: t.querySelector("#todo-form"),
          todoListArea: t.querySelector("#todo-list-area"),
      ...
      ((t.todoList.innerHTML = ""),
        ...
        c().forEach((n) => {
          t.todoList.append(
            (function (t, n) {
              ...
              if (
                ((e.className = "todo-item"),
                e.classList.toggle("is-complete", t.completed),
                n.editingTodoId === t.id)
              )
                return (
                  ...
                  e.append(
                    (function (t, n) {
                      ...
                      ((s.value = t.notes || ""),
                        (s.rows = 3),
                        s.setAttribute("aria-label", "Edit notes"),
                        (s.placeholder = "Notes"));
                      ...
                      ((p.className = "cancel-button"),
                        ...
                        e.addEventListener("keydown", (t) => {
                          "Escape" === t.key && n.onCancelEdit();
                        }),
                        p.addEventListener("click", () => {
                          n.onCancelEdit();
                        }));
                      const l = document.createElement("div");
                      ((l.className = "edit-field-row"), l.append(o, r, a));
              ...
              ((s.className = `task-due-date ${(function (t, n) {
                ...
                if (n) return "is-complete";
                const e = new Date();
                e.setHours(0, 0, 0, 0);
                const o = new Date(`${t}T00:00:00`);
              ...
              ((d.className = "task-description"),
                (d.textContent = t.description || "No added context"));
              const c = document.createElement("span");
              ((c.className = "task-checklist-summary"),
                (c.textContent = (function (t = []) {
                  return t.length
                    ? `${t.length} checklist ${1 === t.length ? "item" : "items"}`
                    : "";
                })(t.checklist)));
              const p = document.createElement("button");
              ...
              u.className = "task-content";
              const m = document.createElement("span");
              ((m.className = "task-header"), m.append(a, i));
        ...
        (function () {
          const n = O(),
            ...
            o = n.length - e,
            r = 1 === e ? "task" : "tasks";
          ((t.totalCount.textContent = n.length),
            (t.activeCount.textContent = e),
            (t.completedCount.textContent = o),
            (t.todoCount.textContent = `${e} open ${r}`),
        ...
        (function () {
          ...
          ((t.currentProjectName.textContent = n
            ? n.name
            : "No project selected"),
            (t.currentProjectMeta.textContent = n
              ? `${e} ${o} in this project`
    ...
    function x() {
      ...
      ((t.workspaceHeader.hidden = !n),
        ...
        (t.addTaskButton.title = i ? "Hide task form" : "Add task"),
        t.addTaskButton.setAttribute(
          "aria-label",
          i ? "Hide task form" : "Add task",
        ),
    ...
    (t.projectInput.addEventListener("input", k),
      ...
      t.projectForm.addEventListener("submit", (e) => {
        e.preventDefault();
        const r = t.projectInput.value.trim();
        r &&
          ((function (t, n) {
            const e = h({ name: n });
            t.push(e);
